import { ADD_PROGRAM, SEARCH_PROGRAM, SET_EDIT, DELETE_PROGRAM, EDIT_PROGRAM, SET_PROGRAM_LIST, FILTER_STATE, CLEAR_PROGRAMS} from "../actions/programActions";
...
const programReducer = (state = initialState, action) => {
  switch (action.type) {
    case ADD_PROGRAM:
      return {...state, "program_list": [...state.program_list, action.payload]}
    case SEARCH_PROGRAM:
